...
def do_test(client, live_server, make_test_use_extra_browser=False):
    ...
    test_url = f"https://scry.shinyspells.com/ci-test.html?non-custom-default=true"
        ...
        res = client.post(
            ...
            data={
                # 'run_customer_browser_url_tests.sh' will search for this string to know if we hit the right browser container or not
                  "url": f"https://scry.shinyspells.com/ci-test.html?custom-browser-search-string=1",
                  "tags": "",
                  "headers": "",
